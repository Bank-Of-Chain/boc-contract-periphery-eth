...
describe('【DForceRevolvingLoanDaiStrategy Strategy Checker】', function () {
  checker.check('DForceRevolvingLoanDaiStrategy',async function (strategyAddress) {},null,async function (strategyAddress,customAddressArray) {
