...
describe('【EulerRevolvingLoanUsdtStrategy Strategy Checker】', function () {
  checker.check('EulerRevolvingLoanUsdtStrategy',async function (strategyAddress) {},async function (strategyAddress,customAddressArray) {
