...
const UniswapV3DaiUsdt500Strategy = hre.artifacts.require("UniswapV3DaiUsdt500Strategy");
...
describe('【UniswapV3DaiUsdt500Strategy Strategy Checker】', function () {
    checker.check('UniswapV3DaiUsdt500Strategy', async function (strategy) {
        ...
        const beforeBaseMintInfo = await uniswapV3DaiUsdt500Strategy.baseMintInfo();
        ...
        const afterBaseMintInfo = await uniswapV3DaiUsdt500Strategy.baseMintInfo();
