...
const UniswapV3BusdUsdc500Strategy = hre.artifacts.require("UniswapV3BusdUsdc500Strategy");
...
describe('【UniswapV3BusdUsdc500Strategy Strategy Checker】', function () {
    checker.check('UniswapV3BusdUsdc500Strategy', async function (strategy) {
        ...
        const beforeBaseMintInfo = await uniswapV3BusdUsdc500Strategy.baseMintInfo();
        ...
        const afterBaseMintInfo = await uniswapV3BusdUsdc500Strategy.baseMintInfo();
