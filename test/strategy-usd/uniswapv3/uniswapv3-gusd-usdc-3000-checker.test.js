...
const UniswapV3GusdUsdc3000Strategy = hre.artifacts.require("UniswapV3GusdUsdc3000Strategy");
...
describe('【UniswapV3GusdUsdc3000Strategy Strategy Checker】', function () {
    checker.check('UniswapV3GusdUsdc3000Strategy', async function (strategy) {
        ...
        const beforeBaseMintInfo = await uniswapV3GusdUsdc3000Strategy.baseMintInfo();
        ...
        const afterBaseMintInfo = await uniswapV3GusdUsdc3000Strategy.baseMintInfo();
