...
describe('【AaveDaiStrategy Strategy Checker】', function() {
    checker.check('AaveDaiStrategy',async function (strategyAddress) {
        ...
        //     userAccountData.ltv.toString(),
        //     userAccountData.healthFactor.toString());
        // mockPriceOracle.setAssetPrice(MFC.stETH_ADDRESS,ethPrice.multipliedBy(90).dividedBy(100).toFixed(0,2));
        ...
        //     userAccountData.ltv.toString(),
        //     userAccountData.healthFactor.toString());
        // mockPriceOracle.setAssetPrice(MFC.stETH_ADDRESS,ethPrice.multipliedBy(100).dividedBy(100).toFixed(0,2));
