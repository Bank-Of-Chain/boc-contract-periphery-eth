...
describe('【AaveWETHstETHStrategy Strategy Checker】', function() {
    checker.check('AaveWETHstETHStrategy',async function (strategy) {
        ...
        await mockPriceOracle.setAssetPrice(MFC.stETH_ADDRESS,ethPrice.multipliedBy(120).dividedBy(100).toFixed(0,2));
        ...
        console.log("before rebalance1 borrowInfo(remainingAmount,overflowAmount,_overflowDebtAmount)=",borrowInfo._remainingAmount.toString(),borrowInfo._overflowAmount.toString(),borrowInfo._overflowDebtAmount.toString());
        await strategy.rebalance({from:keeper});
        borrowInfo = await strategy.borrowInfo({from:keeper});
        console.log("after rebalance1 borrowInfo(remainingAmount,overflowAmount,_overflowDebtAmount)=",borrowInfo._remainingAmount.toString(),borrowInfo._overflowAmount.toString(),borrowInfo._overflowDebtAmount.toString());
        userAccountData = await lendingPool.getUserAccountData(strategyAddress);
        console.log(userAccountData.totalCollateralETH.toString(),
            userAccountData.totalDebtETH.toString(),
            userAccountData.availableBorrowsETH.toString(),
            ...
            userAccountData.ltv.toString(),
            userAccountData.healthFactor.toString());
        // mockPriceOracle.setAssetPrice(MFC.stETH_ADDRESS,ethPrice.multipliedBy(130).dividedBy(100).toFixed(0,2));
        ...
        //     userAccountData.healthFactor.toString());
        // borrowInfo = await strategy.borrowInfo({from:keeper});
        // console.log("before rebalance2 borrowInfo(remainingAmount,overflowAmount,_overflowDebtAmount)=",borrowInfo._remainingAmount.toString(),borrowInfo._overflowAmount.toString(),borrowInfo._overflowDebtAmount.toString());
        // await strategy.rebalance({from:keeper});
        // borrowInfo = await strategy.borrowInfo({from:keeper});
        // console.log("after rebalance2 borrowInfo(remainingAmount,overflowAmount,_overflowDebtAmount)=",borrowInfo._remainingAmount.toString(),borrowInfo._overflowAmount.toString(),borrowInfo._overflowDebtAmount.toString());
        // userAccountData = await lendingPool.getUserAccountData(strategyAddress);
        // console.log(userAccountData.totalCollateralETH.toString(),
        //     userAccountData.totalDebtETH.toString(),
        //     userAccountData.availableBorrowsETH.toString(),
